...
if("TRUE" STREQUAL "TRUE")
  set(differential_drive_SOURCE_PREFIX /home/innowingintern/diff_drive_rover/ros-workspace/src/differential-drive)
  set(differential_drive_DEVEL_PREFIX /home/innowingintern/diff_drive_rover/ros-workspace/devel)
  ...
  set(differential_drive_INSTALL_PREFIX /home/innowingintern/diff_drive_rover/ros-workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'differential_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/innowingintern/diff_drive_rover/ros-workspace/src/differential-drive/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT differential_drive_NUM_DUMMY_TARGETS)
      set(differential_drive_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::differential_drive::wrapped-linker-option${differential_drive_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR differential_drive_NUM_DUMMY_TARGETS "${differential_drive_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::differential_drive::wrapped-linker-option${differential_drive_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND differential_drive_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/innowingintern/diff_drive_rover/ros-workspace/devel/lib;/opt/ros/melodic/lib)
